...
LEFIN;
	...
	public function message_posted($evt, $arg) {
		...
		$message = wordwrap($message);
		$priority = Issues::translate_priority($priority_id);
		$status = Issues::translate_status($status_id);
...
LEFIN;
	...
	public function issue_status_changed($evt, $arg) {
		...
		//   old_priority_id, old_status_id, old_assigned_user_id,
		//   priority_id, status_id, assigned_user_id
		...
		if ($status_id != $old_status_id) {
			$old_status = Issues::translate_status($old_status_id);
			$new_status = Issues::translate_status($status_id);
